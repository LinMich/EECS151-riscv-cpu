...
#
# Generated by export_simulation on Wed Apr 04 18:12:14 -0700 2018
#
################################################################################
...
'-reset_run' switch to the './imem_blk_ram.sh' script.

./imem_blk_ram.sh -reset_run
...
./imem_blk_ram.sh -noclean_files

For more information on the script, please type './imem_blk_ram.sh -help'.
