...
#
# Generated by export_simulation on Wed Apr 04 18:12:21 -0700 2018
#
################################################################################
...
'-reset_run' switch to the './dmem_blk_ram.sh' script.

./dmem_blk_ram.sh -reset_run
...
./dmem_blk_ram.sh -noclean_files

For more information on the script, please type './dmem_blk_ram.sh -help'.
