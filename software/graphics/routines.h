...
#define LE_X0 (*((volatile uint32_t*)0xa0010000))
#define LE_X1 (*((volatile uint32_t*)0xa0010004))
#define LE_Y0 (*((volatile uint32_t*)0xa0010008))
#define LE_Y1 (*((volatile uint32_t*)0xa001000c))
#define LE_COLOR (*((volatile uint32_t*)0xa0010010))
#define LE_FIRE (*((volatile uint32_t*)0xa0010014))
