...
#
# Generated by export_simulation on Wed Apr 04 18:12:19 -0700 2018
#
################################################################################
...
'-reset_run' switch to the './bios_mem.sh' script.

./bios_mem.sh -reset_run
...
./bios_mem.sh -noclean_files

For more information on the script, please type './bios_mem.sh -help'.
