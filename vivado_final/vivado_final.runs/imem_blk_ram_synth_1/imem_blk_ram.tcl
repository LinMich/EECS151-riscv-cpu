...
synth_design -top imem_blk_ram -part xc7z020clg400-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix imem_blk_ram_ imem_blk_ram.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ imem_blk_ram_stub.v
 lappend ipCachedFiles imem_blk_ram_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ imem_blk_ram_stub.vhdl
 lappend ipCachedFiles imem_blk_ram_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ imem_blk_ram_sim_netlist.v
 lappend ipCachedFiles imem_blk_ram_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ imem_blk_ram_sim_netlist.vhdl
 lappend ipCachedFiles imem_blk_ram_sim_netlist.vhdl

 config_ip_cache -add -dcp imem_blk_ram.dcp -move_files $ipCachedFiles -use_project_ipc -ip [get_ips imem_blk_ram]
}

rename_ref -prefix_all imem_blk_ram_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef imem_blk_ram.dcp
